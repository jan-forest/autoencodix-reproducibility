...
#$PYTHON_INTERPRETER create_cfg_fastertest.py
...
cp ./reports/Exp5_TCGA_MNIST/figures/* ./reports/paper-visualizations/Exp5 #TODO specify paper only
cp ./reports/Exp5_TCGA_MNIST/*.csv ./reports/paper-visualizations/Exp5     #TODO specify paper only
